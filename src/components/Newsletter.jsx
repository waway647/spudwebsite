        ...
        <div className='w-full py-16 text-white px-4'>
            <div className='max-w-[1240px] mx-auto grid lg:grid-cols-3'>
                ...
                <div className='my-4'>
                    ...
                    <p className='lg:text-left md:text-center sm:text-center text-center'>We care about the protection of your data. Read our {' '}<span className='text-[#00df9a]'>Privacy Policy</span></p>
                </div>
            </div>
        </div> 
    )
